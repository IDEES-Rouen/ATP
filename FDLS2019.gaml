...
//	int producer_strategy <- 1 parameter: true min: 1 max: 2; //1: produce just what has been oredered. 2: produce the maximum it can
	...
	int complexityEnvironment <- 5;//0 = no complexity; 1 = use distance; 2 = ground properties; 3 = policies; 4 = real case; 5 = open world;
	int complexityConsumer <- 2;//0 = no rebuilt; 1 = rebuilt; 2 = 2 types of needs + priority and prestige; 3 = real localisation;
	int complexityProducer <- 2;//0 = production infinite; 1 = production not infinite; 2 = 2 types of prod; 3 = reuse;
	/*
